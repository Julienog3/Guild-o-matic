...
interface AddingGuildModalStepInterface {
  title: string;
  type: AddingGuildModalStepEnum;
  component: React.ReactNode;
}

interface AddingGuildModalProps {
  onClose: () => void;
  onSubmit: () => void;
}

const AddingGuildModal = ({
  onClose,
  onSubmit,
}: AddingGuildModalProps): JSX.Element => {
  ...
  const steps: AddingGuildModalStepInterface[] = [
    {
      title: 'Informations générales',
      type: AddingGuildModalStepEnum.GENERAL,
      component: (
        <GeneralStep
    ...
    },
    {
      ...
      type: AddingGuildModalStepEnum.DESCRIPTION,
      component: (
        <DescriptionStep
          guildPayload={guildToAdd}
          handleChange={(guild) => setGuildToAdd(guild)}
    ...
    },
    {
      ...
      type: AddingGuildModalStepEnum.IMAGE,
      component: (
        <ImageStep
          guildPayload={guildToAdd}
          handleChange={(guild) => setGuildToAdd(guild)}
...
export default AddingGuildModal;
