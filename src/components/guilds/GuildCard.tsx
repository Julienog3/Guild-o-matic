...
const GuildCard = ({ guild }: GuildCardProps): JSX.Element => {
  return <article className="guild-card bg-light-blue rounded-lg overflow-hidden hover:outline outline-1 outline-accent-blue transition group">
    <div className="relative h-44 w-full p-6 overflow-hidden flex flex-col ">
      ...
      <div className="absolute top-0 left-0 w-full h-full guild-card__image">
        <img className="absolute h-full object-cover w-full group-hover:scale-110 transition-transform" src="./images/bg-card.jpg" alt="" />
      </div>
    </div>
    <div className="p-4 flex justify-between">
      <div className="flex gap-4 items-center">
        <img className="rounded-xl w-10 h-10" src="https://avatarfiles.alphacoders.com/108/thumb-108702.jpg" alt="" />
